...
La nostra funzione printName dovrà semplicemente fare un console.log() del nostro nome (ricordiamoci che sarà la funzione di callback). 
...
Indicazioni utili: Il risultato finale sarà "Hello" "Nome", stampato sul vostro terminale
 */
